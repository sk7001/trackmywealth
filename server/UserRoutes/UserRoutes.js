...
const { register, login, verifyUser, resendVerification, updateUser, forgotPassword, verifyPasswordOTP, updatePassword, getUser, uploadImage } = require('../UserController/UserController');
